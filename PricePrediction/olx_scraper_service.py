...
- ✅ "Samsung Galaxy A52s PTA approved" → "true" if expected model is "Galaxy A52s"
...
- condition_score (ALWAYS set this to null)
- pta_approved  
- is_panel_changed  
- screen_crack  
- panel_dot  
...
Always set condition_score to null.    
                                                                                                                
Return the result strictly as a **JSON object**.
                                                          
CRITICAL:
-- The json should NOT be covered in any additional text or explanation.
-- NO ````json` blocks or markdown formatting.     
...
def extract_data(data: dict, model, brand):
    try:
        ...
        # Convert to list instead of string
...
scrape_used_data("Pixel 7A", "Google")
